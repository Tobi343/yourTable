...
function Sidebar() {
    return (
    <div id="sideBar" className="bg-yellow-500  text-blue-100 w-64 space-y-6 px-2 py-7 sticky min-h-screen inset-y-0 left-0 transform -translate-x-full md:translate-x-0 transition duration-200 ease-in-out">    
