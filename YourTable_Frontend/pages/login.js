  ...
  return (
    <section class="min-h-screen flex items-stretch text-white ">
      <div className="lg:flex w-1/2 hidden bg-gray-900 relative items-center">
        <div class="absolute bg-LoginBackground opacity-50 bg-cover inset-0 z-0"></div>
        <div class="w-full px-24 z-10">
          <h1 class="text-5xl font-bold text-left tracking-wide">YourTable</h1>
      ...
      <div class="lg:w-1/2 bg-gray-800 w-full flex items-center justify-center text-center md:px-16 px-0 z-0">
